...
public class ProductWithReviewsResponse {
    ...
    private List<ProductReviewDetailsResponse> productReviews;

    public static ProductWithReviewsResponse from(Product product) {
        ...
        response.setProductReviews(
                product.getProductReviews().stream()
                        .map(ProductReviewDetailsResponse::from)
                        .toList()
        );
        return response;
    }
    ...
    public List<ProductReviewDetailsResponse> getProductReviews() {
        return productReviews;
    }

    public void setProductReviews(List<ProductReviewDetailsResponse> productReviews) {
