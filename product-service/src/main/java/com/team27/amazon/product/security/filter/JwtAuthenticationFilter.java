package com.team27.amazon.product.security.filter;

import java.io.IOException;
import java.util.Collections;

import com.team27.amazon.product.security.JwtService;
import com.team27.amazon.product.security.auth.AuthContext;
import com.team27.amazon.product.security.auth.AuthHandler;
import com.team27.amazon.product.security.auth.AuthResult;
import com.team27.amazon.product.security.auth.RoleAuthorizationHandler;
import com.team27.amazon.product.security.auth.SignatureValidationHandler;
import com.team27.amazon.product.security.auth.TokenExtractionHandler;
import com.team27.amazon.product.security.auth.UserLoaderHandler;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return "/api/products/health".equals(path)
            || "/error".equals(path)
